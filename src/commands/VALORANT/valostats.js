...
module.exports = {
    ...
    async execute(client, interaction){
        ...
        const statsEmbed = new EmbedBuilder()
            .setTitle(`Valorant Alltime Stats [${userData.Account_Data.data.name + "#" + userData.Account_Data.data.tag}]`)
            .setAuthor({name: `Stats requested by ${interaction.user.tag}`, iconURL: `${interaction.user.displayAvatarURL()}`})
            .setThumbnail(`${userData.MMR_Data.data.current_data.images.small}`)
            .setColor("#fa4454")
            .addFields(
            ...
            .setImage(`${userData.Account_Data.data.card.wide}`)
